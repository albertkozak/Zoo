...
namespace Zoo
{
    class Bear : Mammal
    {
        const double BB_SERVE_WEIGHT_RATIO = 0.014;
        const double PB_SERVE_WEIGHT_RATIO = 0.016;
        public void GetBear() {
            ...
            if (input == "1") {
                species = "Black";
                double servingToWeightRatio = BB_SERVE_WEIGHT_RATIO;
                ...
                species = "Polar";
                double servingToWeightRatio = PB_SERVE_WEIGHT_RATIO;
                double mammalWeight = base.GetMammalWeight();
